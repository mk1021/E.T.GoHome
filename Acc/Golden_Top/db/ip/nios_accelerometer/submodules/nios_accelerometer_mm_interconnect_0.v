...
module nios_accelerometer_mm_interconnect_0 (
	...
	wire  [95:0] cmd_mux_003_src_data;                                                                      // cmd_mux_003:src_data -> cpu_debug_mem_slave_agent:cp_data
	...
	wire  [95:0] cmd_mux_004_src_data;                                                                      // cmd_mux_004:src_data -> onchip_memory_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                                     // onchip_memory_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [9:0] cmd_mux_004_src_channel;                                                                   // cmd_mux_004:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_005_src_channel;                                                                   // cmd_mux_005:src_channel -> led_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_006_src_channel;                                                                   // cmd_mux_006:src_channel -> HEX0_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_007_src_channel;                                                                   // cmd_mux_007:src_channel -> HEX1_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_008_src_channel;                                                                   // cmd_mux_008:src_channel -> HEX2_s1_agent:cp_channel
	...
	wire  [95:0] cmd_mux_009_src_data;                                                                      // cmd_mux_009:src_data -> timer_s1_agent:cp_data
	...
	wire  [95:0] cpu_debug_mem_slave_agent_rp_data;                                                         // cpu_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [95:0] onchip_memory_s1_agent_rp_data;                                                            // onchip_memory_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [95:0] timer_s1_agent_rp_data;                                                                    // timer_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [95:0] cmd_demux_001_src2_data;                                                                   // cmd_demux_001:src2_data -> cmd_mux_009:sink0_data
	...
	wire  [95:0] rsp_demux_009_src0_data;                                                                   // rsp_demux_009:src0_data -> rsp_mux_001:sink2_data
	...
	nios_accelerometer_mm_interconnect_0_router_003 router_004 (
	...
	nios_accelerometer_mm_interconnect_0_router_005 router_005 (
	...
	nios_accelerometer_mm_interconnect_0_router_005 router_006 (
	...
	nios_accelerometer_mm_interconnect_0_router_011 router_011 (
	...
	nios_accelerometer_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_accelerometer_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_accelerometer_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_accelerometer_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_accelerometer_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_accelerometer_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
