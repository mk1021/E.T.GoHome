...
def handle_client(conn,addr):
    ...
    player1room1finished = False
    player2room1finished = False
    q = False
    w = False
    while True:            
            ...
            elif data.startswith("Room1"):
                room, player = data.split("/")
                if player == "player1finished":
                    player1room1finished = True
                if player == "player2finished":
                    player2room1finished = True

                if player1room1finished and player2room1finished:
                    player1_conn.send("Room1_finished ")
                    player2_conn.send("Room1_finished ")
